        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <Button title={actionLabel} onPress={formik.handleSubmit} />
                </View>
            </View>
        </ScrollView>
    );
...
const styles = StyleSheet.create({
    container: {
        padding: 20,
        backgroundColor: '#f9f9f9', // Fondo claro para mejor contraste
    },
    errorText: {
        color: '#ff4d4d', // Rojo más vibrante
        fontSize: 14, // Tamaño de texto más visible
        marginBottom: 10,
        fontWeight: '600', // Aumenta el peso para destacar el error
    },
    imageContainer: {
        flexDirection: 'row',
    ...
    label: {
        fontSize: 18, // Texto más grande y visible
        color: '#333',
        marginBottom: 5,
        fontWeight: 'bold', // Negrita para destacar
    },
    imageWrapper: {
        width: 60, // Aumenta el tamaño de la imagen
        height: 60,
        borderRadius: 40,
        backgroundColor: '#e0e0e0',
        justifyContent: 'center',
        alignItems: 'center',
        shadowColor: '#000', // Sombra para darle más profundidad
    ...
    input: {
        ...
        borderColor: '#ccc',
        color: '#666',
        padding: 12, // Aumenta el padding para más comodidad
        borderRadius: 8, // Bordes más redondeados
        marginBottom: 15, // Más espacio entre los inputs
        backgroundColor: '#fff', // Fondo blanco para destacar el campo de entrada
        shadowColor: '#000',
    ...
    buttonContainer: {
        flexDirection: 'row',
        justifyContent: 'space-between',
        marginTop: 20, // Añadir margen superior para separar botones
    },
});
...
const pickerStyles = {
    inputIOS: {
        ...
        marginBottom: 12,
        color: '#4d4d4d', // Color de texto seleccionado más oscuro
        backgroundColor: '#fff',
    },
    inputAndroid: {
        height: 45,
    ...
    placeholder: {
        color: '#a3a3a3', // Color del placeholder más suave
    },
};
