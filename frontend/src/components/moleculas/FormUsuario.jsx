...
const validationSchema = yup.object().shape({
    ...
    nombre: yup
 	 ...
 	 .matches(/^[a-zA-ZñÑ\s]{1,20}$/, 'El nombre debe tener máximo 20 caracteres, y solo puede contener letras y espacios'),
    apellido: yup
        .string()
        .required('El apellido es obligatorio')
 	 .matches(/^[a-zA-ZñÑ\s]{1,20}$/, 'El apellido debe tener máximo 20 caracteres, y solo puede contener letras y espacios'),
    direccion: yup
        .string()
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            <div className='flex flex-wrap justify-between'>
                <div className='flex flex-col w-full md:w-1/2 p-2'>
                    <div className="py-2">
                        <select
                            className="pl-2 pr-4 py-2 w-80 h-14 text-sm border-2 rounded-xl border-gray-200 hover:border-gray-400 shadow-sm text-black focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                            name="tipo_documento"
            ...
            <ModalFooter>
                ...
                <Button
                    type='submit' className='text-white bg-black'
                >
                    {actionLabel}
                </Button>
            </ModalFooter>
