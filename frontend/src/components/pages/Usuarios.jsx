                    ...
                    <div className="flex flex-col  mt-3">
                        <div className="flex justify-between gap-3 items-end">
                            ...
                            <div className="flex gap-3">
                                <Button className="mr-30 text-white bg-black" style={{ position: 'relative' }} endContent={<PlusIcon />} onClick={() => handleToggle('create')}>
                                    Registrar
                                </Button>
                            </div>
                        </div>
            ...
            return (
                <div className="py-2 px-2 flex justify-between items-center m-3">
                    ...
                    <div className="hidden sm:flex w-[40%] justify-end gap-2">
                        <Button isDisabled={pages === 1} size="md" variant="shadow" className="text-white bg-black" onPress={onPreviousPage}>
                            Anterior
                        </Button>
                        <Button isDisabled={pages === 1} size="md" className="text-white bg-black mr-58" variant="shadow" onPress={onNextPage}>
                            Siguiente
                        </Button>
                    </div>
                </div>
