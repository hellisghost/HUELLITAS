                    ...
                    <div className="flex flex-col mt-3">
                        <div className="flex justify-between gap-3 items-end">
                            ...
                            <div className="z-0 flex gap-3">
                                ...
                                <Button variant="bordered" className="z-1 text-white bg-black" style={{ position: 'relative' }} endContent={<PlusIcon />} onClick={() => handleToggle('create')}>
                                    Registrar
                                </Button>
                                <Button as={Link} to="/reportes" variant="bordered" className="text-white bg-black">
                                    Reportes
                                </Button>
                            </div>
