...
const NotificacionesMascotas = () => {
    ...
    const renderCard = useCallback((mascota) => {
        return ( 
            <Card key={mascota.id_mascota} className="p-1 bg-gray-300 shadow-lg">
                <CardHeader className="pb-1 pt-1 flex-col items-start">
                    <h4 className="font-bold text-2xl mb-1 text-gray-800">Nombre: {mascota.nombre_mascota}</h4>
                    <small className="text-gray-600 mb-1">Género: {mascota.sexo}</small>
                ...
                <CardBody className="overflow-visible py-2">
                    ...
                    <div className="flex justify-start gap-2">
                        <Button className='bg-black text-white' onClick={() => handleAdoptar(mascota.id_adopcion)}>
                            Aceptar
                        </Button>
